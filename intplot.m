function intplot( pheno, mk1, mk2, mnames, labels )
% INTPLOT Plot interaction effects for two-QTL model.
%         
% INTPLOT(PHENO,MK1,MK2)
% INTPLOT(PHENO,MK1,MK2,MNAMES)    
% INTPLOT(PHENO,MK1,MK2,MNAMES,LABELS)
...
%	$Revision: 0.834 $ $Date: 2001/08/17 21:37:43 $	
